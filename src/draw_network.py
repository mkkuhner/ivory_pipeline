...
# Changes for this version:  Run in the parent directory of all
# seizures; put auxillary files in ivory_paths rather than hard coding.
...
if len(sys.argv) != 4:
  ...
  print("Relies on information set up by step4_finalreports.py")
  print("and present in subdirectory fammatch_global")
  exit(-1)
