# step3_voronoi.py takes a seizure which has been run through SCAT and runs
# VORONOI on it, if possible.  It should be run in the parent directory of
# all seizures, and given the prefix of the desired seizure and an 
# ivory_paths file.
...
# This program also writes reports and images for both SCAT and VORONOI,
# if VORONOI ran; otherwise just for SCAT.
